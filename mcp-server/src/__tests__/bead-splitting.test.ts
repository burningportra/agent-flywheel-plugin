...
function makeInsights(bottlenecks: Array<{ ID: string; Value: number }> = []): BvInsights {
  return {
...
describe('identifyBottlenecks', () => {
  it('returns empty for null/empty Bottlenecks', () => {
    ...
    expect(identifyBottlenecks({ ...makeInsights(), Bottlenecks: null as any }, beads)).toEqual([]);
    expect(identifyBottlenecks({ ...makeInsights(), Bottlenecks: undefined as any }, beads)).toEqual([]);
  });
