...
import { applyBaseline, generateBaseline, toRepoRelativePosix, computeFingerprint, } from "../../lint/baseline.js";
...
describe("toRepoRelativePosix", () => {
    ...
    it("leaves an already-relative path repo-relative (POSIX form)", () => {
        expect(toRepoRelativePosix("skills/start/SKILL.md", "/tmp/myrepo")).toBe("skills/start/SKILL.md");
    });
...
describe("baseline portability across worktrees (unit)", () => {
    ...
    it("applyBaseline matches a finding from a different worktree (repo-relative)", () => {
        ...
        const { live, baselined } = applyBaseline([findingFromWorktreeB], baseline, source, worktreeB);
...
//# sourceMappingURL=baseline-portable.test.js.map