...
import { computeExecutionOrder, computeParallelGroups, detectFileConflicts, simulateExecutionPaths, } from '../plan-simulation.js';
vi.mock('../beads.js', () => ({
    extractArtifacts: vi.fn(() => []),
}));
function bead(id, deps = [], files = []) {
    return {
        id,
        title: `Bead ${id}`,
        deps,
...
//# sourceMappingURL=plan-simulation.test.js.map