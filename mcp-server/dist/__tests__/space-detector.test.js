...
import { countUncertaintySignals, detectSpaceViolations, extractBeadFiles, formatSpaceViolations, } from '../space-detector.js';
function makeBead(description) {
    return {
        id: 'test-bead',
        title: 'test',
        description,
...
describe('detectSpaceViolations', () => {
    ...
    it('marks uncertainty critical when 5+ signals present', () => {
        const bead = makeBead('### Files: src/foo.ts');
        const hedge = "I think this might need work. Not sure if it works. Probably a workaround. Maybe we should rethink. I'm not confident.";
...
//# sourceMappingURL=space-detector.test.js.map