...
function resolveBundlePath(opts) {
    if (opts?.bundlePath)
        return path.resolve(opts.bundlePath);
...
// --- integrity check ------------------------------------------------------
function verifyManifestSha(bundle) {
 ...
 * integrity failure.
 */
export function loadSkillsBundle(bundlePath) {
...
export function _resetSkillsBundleCache() {
    _cache = null;
    _cacheKey = null;
}
async function walkDiskSkills(repoRoot) {
...
async function readSkillFromDisk(name, repoRoot) {
