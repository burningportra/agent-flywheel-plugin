...
const PRIMARY_TOOLS = [
    ...
    },
    {
        ...
        description: 'Audit a wave of closed beads for compliance with their acceptance criteria via the standalone /beads-compliance-and-completion-verification skill. ' +
...
const DEFAULT_RUNNERS = {
    ...
    orch_compliance_audit: runComplianceAudit,
...
const EXTENSION_RUNNERS = {
    ...
    flywheel_remediate: async (ctx, args) => {
        ...
        return runRemediate(parsed, ctx.exec, ctx.signal ?? new AbortController().signal);
    },
...
export function createServer() {
    const server = new Server({ name: 'agent-flywheel', version: VERSION }, { capabilities: { tools: {} } });
