 ...
 */
export async function ensureCoreRules(cwd) {
    const agentsMdPath = join(cwd, "AGENTS.md");
    if (!existsSync(agentsMdPath)) {
...
export async function ensureAgentMailSection(cwd) {
    const agentsMdPath = join(cwd, "AGENTS.md");
    if (!existsSync(agentsMdPath)) {
        writeFileSync(agentsMdPath, DEFAULT_HEADER +
