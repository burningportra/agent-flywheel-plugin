...
export type FlywheelToolName = 'flywheel_profile' | 'flywheel_discover' | 'flywheel_select' | 'flywheel_plan' | 'flywheel_approve_beads' | 'flywheel_review' | 'flywheel_verify_beads' | 'flywheel_compliance_audit' | 'flywheel_advance_wave' | 'flywheel_memory' | 'flywheel_doctor' | 'flywheel_get_skill' | 'flywheel_observe' | 'orch_profile' | 'orch_discover' | 'orch_select' | 'orch_plan' | 'orch_approve_beads' | 'orch_review' | 'orch_verify_beads' | 'orch_compliance_audit' | 'orch_advance_wave' | 'orch_memory' | 'orch_get_skill' | 'orch_observe';
