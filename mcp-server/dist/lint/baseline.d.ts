...
export declare function applyBaseline(findings: Finding[], baseline: BaselineFile | null, source: string): {
    live: Finding[];
    baselined: Finding[];
};
export declare function generateBaseline(findings: Finding[], source: string, generated?: string): BaselineFile;
export {};
